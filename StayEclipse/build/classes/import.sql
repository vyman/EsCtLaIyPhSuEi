...
insert into staynearbyplaces (id, discription, distance, photo, place_name, stay_id) values (1, 'place1', '20', 'http://localhost:8080/nuxeo/nxbigfile/default/f7fbc39c-602e-48e6-8911-aa057699d565/file:content/s1.jpg', 'test1', 1000);
insert into staynearbyplaces (id, discription, distance, photo, place_name, stay_id) values (2, 'place2', '30', 'http://localhost:8080/nuxeo/nxbigfile/default/6582f349-d976-4b72-b67d-6a54e887d76b/file:content/s2.jpg', 'test2', 1000);
insert into staynearbyplaces (id, discription, distance, photo, place_name, stay_id) values (3, 'place2', '40', 'http://localhost:8080/nuxeo/nxbigfile/default/8b7a4d8b-18f1-438b-94b0-b4eb7bae444b/file:content/s3.jpg', 'test3', 1000);


insert into staymenu (id, menuphoto, stay_id) values (1, 'http://localhost:8080/nuxeo/nxbigfile/default/d3651c14-2c80-44cc-85af-fb3075321d1c/file:content/pic2.jpg', 1000);

insert into staysuite (staysuite_id, discription, number_of_avilable_rooms, price, suite_code, stay_id, suite_type ,picpath) values (1, 'single room', 2, 100, 'A01', 1000, 1,'http://localhost:8080/nuxeo/nxbigfile/default/8b7a4d8b-18f1-438b-94b0-b4eb7bae444b/file:content/s3.jpg');

insert into staysuitephotos (id, discription, imagepath, staysuite_id) values (1, 'etroordinary room', 'http://localhost:8080/nuxeo/nxbigfile/default/8b7a4d8b-18f1-438b-94b0-b4eb7bae444b/file:content/s3.jpg', 1);