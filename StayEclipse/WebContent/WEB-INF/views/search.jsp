...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-8 col-xs-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Available Hotels</h3>
        </div>
        ...
        <table width="100%">
           <tr>
          <td width="25%"></td>
          <td width="25%"><b>Hotel Name</b></td>
          <td width="15%"><b></>A/C Delux</b></td>
          <td width="15%"><b>Price</b></td><br>
           </tr>
        <tr>
          <td width="25%"><img src="resources/images/s2.jpg" height="100" /></td>
          <td width="25%">Bangalore Hotel</td>
          <td width="25%"><input type="checkbox">Single Room<br>
          <input type="checkbox">Double Room<br>
          <input type="checkbox">Double+Extra</td> 
          <td width="25%">$400<br>$600<br>$700</td>
          <td width="25%"><button type="button" class="btn btn-sm btn-success" onclick="form.submit("Stay/getStaySuitesAndMenu")"> Book Now</button></td>
        </tr>
        <tr>
          <td width="25%"><img src="resources/images/s3.jpg" height="100" /></td>
          <td width="25%">Bangalore Hotel</td>
          <td width="25%"><input type="checkbox">Single Room<br>
          <input type="checkbox">Double Room<br>
          <input type="checkbox">Double+Extra</td>
        ...
        <tr>
          <td width="25%"><img src="resources/images/s1.jpg" height="100" /></td>
          <td width="25%">Bangalore Hotel</td>
          <td width="25%"><input type="checkbox">Single Room<br>
          <input type="checkbox">Double Room<br>
          <input type="checkbox">Double+Extra</td>
...
<div class="f-container">
  <div class="footersec">
    <div class="f-logo"><a href="index.html"><img src="resources/images/f-logo.png" alt=""></a></div>
    <div class="copyright">&copy; 2014 | <a href="#" >Privacy Policy</a></div>
    <div class="social"> <a href="#"><img src="resources/images/soc_icon_1.png" alt=""></a> <a href="#"><img src="resources/images/soc_icon_2.png" alt=""></a> <a href="#"><img src="resources/images/soc_icon_3.png" alt=""></a> <a href="#"><img src="resources/images/soc_icon_4.png" alt=""></a> </div>
  </div>
</div>
</body>
</html>
